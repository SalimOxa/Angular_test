...
@Component({
  selector: 'app-formation-enlignes',
  templateUrl: './formation-enlignes.component.html',
  styleUrls: ['./formation-enlignes.component.scss']
})
export class FormationEnlignesComponent implements OnInit {
  formation: Formation;
  data: any;
  message: any;
  ...
  public Getformation(): void {
    this.formationService.getFormationsEnligneList().subscribe(
      (response: Formation[]) => {
