...
@Component({
  selector: 'app-formation-banque',
  templateUrl: './formation-banque.component.html',
  styleUrls: ['./formation-banque.component.scss']
})
export class FormationBanqueComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.Getformationbanque()
  }



  public Getformationbanque(): void {
    this.formationService.getFormationsbanqueList().subscribe(
      (response: Formation[]) => {
